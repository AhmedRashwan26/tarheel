        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              content:
                  '• تخصم منصة ترحيل عمولة بنسبة 13.50% فقط من القيمة الإجمالية لكل رحلة مكتملة.\n'
                  '• يتم تحويل صافي أرباح السائق (86.50%) مباشرة إلى الحساب البنكي المسجل والموثق برقم الآيبان (IBAN) بعد انتهاء المشوار وتأكيد العميل.\n'
