...
export class RegisterDriverDto {
  ...
  @ApiProperty({
    example: true,
    description: 'الموافقة على شروط ترحيل: عمولة 10% للتطبيق، وتحويل الأرباح للحساب البنكي المسجل بعد التقييم، ومنع استلام أي مبالغ نقدية',
  })
  @Equals(true, { message: 'يجب الإقرار والموافقة على سياسة منع التعامل النقدي وعمولة ترحيل 10%' })
